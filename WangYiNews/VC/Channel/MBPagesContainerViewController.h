...
@class MBPagesContainerViewController;

@protocol YKPagesContainerViewControllerDataSource <NSObject>

- (UIViewController *)pageViewController:(MBPagesContainerViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController;

- (UIViewController *)pageViewController:(MBPagesContainerViewController *)pageViewController viewControllerAfterViewController:(UIViewController *)viewController;

@end

@interface MBPagesContainerViewController : UIViewController
